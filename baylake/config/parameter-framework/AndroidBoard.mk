...
include $(CLEAR_VARS)
LOCAL_MODULE := parameter-framework.audio.baylake
LOCAL_MODULE_TAGS := optional
LOCAL_REQUIRED_MODULES :=  \
    parameter-framework.audio.baylake.nodomains \
    AudioConfigurableDomains.xml
include $(BUILD_PHONY_PACKAGE)

include $(CLEAR_VARS)
LOCAL_MODULE := parameter-framework.audio.baylake.nodomains
LOCAL_MODULE_TAGS := optional
LOCAL_REQUIRED_MODULES :=  \
...
$(LOCAL_BUILT_MODULE): MY_SRC_FILES := \
        ...
        $(LOCAL_PATH)/criterions.baylake.txt \
        $(LOCAL_PATH)/XML/Settings/Audio/AudioConfigurableDomains.xml \
        $(LOCAL_PATH)/XML/Settings/Audio/baylake_routing.pfw
