...
include $(CLEAR_VARS)
LOCAL_MODULE := parameter-framework.audio.anzhen4_mrd7_wifionly
LOCAL_MODULE_TAGS := optional
LOCAL_REQUIRED_MODULES :=  \
    parameter-framework.audio.anzhen4_mrd7_wifionly.nodomains \
    AudioConfigurableDomains.xml
include $(BUILD_PHONY_PACKAGE)

include $(CLEAR_VARS)
LOCAL_MODULE := parameter-framework.audio.anzhen4_mrd7_wifionly.nodomains
LOCAL_MODULE_TAGS := optional
LOCAL_REQUIRED_MODULES :=  \
...
$(LOCAL_BUILT_MODULE): MY_SRC_FILES := \
        ...
        $(LOCAL_PATH)/XML/Settings/Audio/anzhen4_mrd7_wifionly_routing_realtek5640.pfw \
        $(LOCAL_PATH)/XML/Settings/Audio/anzhen4_mrd7_wifionly_routing_xmm.pfw
...
include $(CLEAR_VARS)
LOCAL_MODULE := parameter-framework.vibrator.anzhen4_mrd7_wifionly
LOCAL_MODULE_TAGS := optional
LOCAL_REQUIRED_MODULES :=  \
