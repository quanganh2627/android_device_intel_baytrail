...
TARGET_KERNEL_TARBALL := $(PLATFORM_PATH)/diskinstaller/kernel.tgz
...
TARGET_SYSLINUX_FILES := $(PLATFORM_PATH)/diskinstaller/intellogo.png \
...
TARGET_SYSLINUX_CONFIG_TEMPLATE := $(PLATFORM_PATH)/diskinstaller/syslinux.template.cfg
TARGET_SYSLINUX_CONFIG := $(PLATFORM_PATH)/diskinstaller/syslinux.cfg
